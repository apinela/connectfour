...
public class Top {
	...
	private int nTop=0;								// Numero de pontuações existentes
	...
	// Método que verifica se o ficheiro do top jÃ¡ existe
	...
	// Método que adiciona ao top uma nova pontuaÃ§Ã£o caso esta seja maior que a Ãºltima 
	...
	// MÃ©todo para obter o array do top com os campos definidos
	...
	// MÃ©todo que coloca os campos da linha 'l' num array de Strings
	...
	// MÃ©todo que obtem a GameInfo da Ãºltima linha
	private GameInfo getLastLineGameInfo() {
		return getLineGameInfo(nTop-1);	
	}
	
	// MÃ©todo que obtem a GameInfo da linha l
	...
	// MÃ©todo para gravar no ficheiro do top as pontuaÃ§Ãµes do array top
	...
	// MÃ©todo que coloca numa string a lista das pontuaÃ§Ãµes existentes no top 
