 ...
 * Jogo 4 em linha
 * 
 * - Jogo criado no Ã¢mbito do 3Âº trabalho da cadeira de ProgramaÃ§Ã£o - LEETC - ISEL
 * - O jogo foi desenvolvido com duas vertentes:
 * 		-> A didÃ¡tica, uma forma de alargar conhecimentos;
 * 		-> A outra contextualizada num nÃ­vel pessoal de cada um dos alunos
 * 		integrando o mesmo num portfolio pessoal; daÃ­ ter sido criado com os nomes de
 * 		classes/mÃ©todos em inglÃªs de forma a, num futuro, inserir o jogo na "cloud" (internet)
 * 		sendo esta a forma fÃ¡cil de internacionalizaÃ§Ã£o do mesmo.  
 * 
 * Autores:
 * 		AndrÃ© Pinela	- 38603
...
public class Connect4 {
	...
	// NÃºmero de peÃ§as reconhecidas em linha
	private static final int IN_LINE=5;
	// NÃºmero de linhas do tabuleiro
	private static final int MAX_LINES=12;
	// NÃºmero de colunas do tabuleiro
	private static final int MAX_COLUMNS=12;
	
	
	public static final char[] SYMBOLS = {'+','-','@','#','$','â','¬','%','&','!','?','=','^','~'};
	...
	// MÃ©todo que inicializa os jogadores
	private static void initializeplayers(boolean fastgame, boolean versusCpu) {

		// Nomes por omissÃ£o e simbolos aleatÃ³rios
		String n1="A";
		String n2="B";
		...
		// Escolher simbolo aleatÃ³rio diferente do primeiro
		do {
	...
	// Método que verifica se hÃ¡ vencedor após a última jogada
	private static void CheckWin() {
		//Verificar se o jogo terminou com a ultima jogada
		if (Game.CheckInLine()) {
			//Incrementar pontuaÃ§Ã£o do jogador actual
	...
	// MÃ©todo que, no caso de empate, incrementa os empates nos GameInfo's de cada jogador
	...
	public static void play(boolean fastGame, boolean versusCpu) {
		...
		public static void addTop(boolean fastGame, boolean versusCpu) {
			...
			if (t.addTop(players[currentPlayer],true)) {
				System.out.println("ParabÃ©ns "+players[currentPlayer].getName() +", entrou para o top.");
				if (fastGame) {
		...
		public static int menu() {		
			...
			// User nomes A e B e simbolos aleatÃ³rios
			System.out.println("\t\t2 - Multiplayer(RÃ¡pido)");
			System.out.println("\t\t3 - Single Player(Normal)");
			System.out.println("\t\t4 - Single Player(RÃ¡pido)");
